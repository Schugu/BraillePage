...
export default function Navbar() {
  return (
    ...
    bg-blue-950 text-white text-xl">
      ...
      <LinkSection LinkTo="/wordsToBraille" Icon="w-8 h-8 icon-[arcticons--braille-de]" Label="Codificador de palabras" />
      <LinkSection LinkTo="/numsToBraille" Icon="w-8 h-8 icon-[arcticons--braille-de]" Label="Codificador de números" />
    </section>
  )
}
